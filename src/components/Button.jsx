        ...
        <div class="container px-6 py-3 mx-auto">
          <div class="flex flex-col items-center justify-center mt-2 space-y-6 md:items-end md:-mx-5 md:space-y-0 md:flex-row">
            <div class="w-full px-6 py-4 transition-colors duration-300 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 dark:bg-gray-800">
              ...
              <button class="w-full h-14  px-4 py-2 mt-10 font-bold tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-500 rounded-md hover:bg-green-600 focus:outline-none focus:bg-green-600">
                <a className="text-xl" href="https://www.payments.biz.id">
                  BELI SEKARANG(COD)
                </a>
              </button>
            </div>
